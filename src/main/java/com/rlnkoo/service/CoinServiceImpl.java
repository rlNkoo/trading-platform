...
import com.rlnkoo.repository.CoinRepository;
...
public class CoinServiceImpl implements CoinService{
    ...
    @Override
    public String getMartketChart(String coinId, int days) throws Exception {
    ...
    @Override
    public String getTredingCoins() throws Exception {
